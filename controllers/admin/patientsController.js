...
const updatePatient = asyncHandler(async (req, res) => {
    ...
    //check se il l'id del dottore è associato veramente a un dottore
    if (await checkDoctor(doctor) !== null) patient.doctor = doctor;
...
module.exports = { getAllPatients, createNewPatient, updatePatient, deletePatient};
